...
#Need this to bypass invalid certificate issue. Should try to fix this
gcontext = ssl.SSLContext(ssl.PROTOCOL_TLSv1_2)

config_file_url = ""
config_file_name = "bootstrap.xml"
...
def main():
    ...
    #config_file_url = "https://raw.githubusercontent.com/kblackstone/PaloAltoNetworks/master/Automation/2Tier-TF-Bootstrap/"
    config_file_url = "https://github.com/torstenstern/professional-services-corner/tree/master/Azure-Scripts/Terraform/Test%20Scripts/"
...
def config_fw():
    ...
    #Config gw
    #Download the config file to local disk
