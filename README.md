...
This framework is licensed under the MIT license and is community supported. The license can be found [here](./LICENSE), the support policy can be found [here.](./SUPPORT_POLICY)
